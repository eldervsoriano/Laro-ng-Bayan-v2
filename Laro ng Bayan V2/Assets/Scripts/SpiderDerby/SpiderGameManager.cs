...
//        // Setup AI controller if not already assigned
//        if (aiController == null && player2Input != null)
//        {
//            aiController = player2Input.GetComponent<AIPlayerController>();
//        }
...
//    // New method to properly start the first round
...
//        // Start AI decision process if enabled
//        if (aiController != null && aiController.IsAIEnabled())
//        {
//            aiController.StartAIDecision(timeToChoose);
//        }
//    }

//    void SetupUI()
//    {
//        // Setup single player toggle
//        if (singlePlayerToggle != null)
//        {
//            singlePlayerToggle.isOn = isSinglePlayerMode;
//            singlePlayerToggle.onValueChanged.AddListener(OnSinglePlayerToggleChanged);
//        }
...
//            difficultyDropdown.options.Add(new Dropdown.OptionData("Expert"));
//            difficultyDropdown.value = 1; // Default to Medium
//            difficultyDropdown.onValueChanged.AddListener(OnDifficultyChanged);
//        }

//        // Initialize AI state based on current settings
//        if (aiController != null)
//        {
//            aiController.EnableAI(isSinglePlayerMode);
//            if (difficultyDropdown != null)
//            {
//                aiController.SetDifficulty((AIPlayerDifficulty)difficultyDropdown.value);
//            }
//        }
//    }

//    void OnSinglePlayerToggleChanged(bool isOn)
//    {
//        isSinglePlayerMode = isOn;

//        if (aiController != null)
//        {
//            aiController.EnableAI(isSinglePlayerMode);

//            // If we're currently in a round and switching to AI mode, start AI decision
//            if (isSinglePlayerMode && isSelecting && !isProcessingRound)
//            {
//                aiController.StartAIDecision(timer);
//            }
//        }
...
//        if (aiController != null)
//        {
//            aiController.SetDifficulty((AIPlayerDifficulty)difficultyIndex);
//        }
//    }
...
//            {
//                string difficultyName = difficultyDropdown != null ?
//                    difficultyDropdown.options[difficultyDropdown.value].text : "Medium";
//                gameModeText.text = $"Single Player vs AI ({difficultyName})";
//            }
//            else
//            {
//                gameModeText.text = "Two Player Mode";
//            }
//        }
//    }
...
//        // Record player choices for AI learning (if AI is enabled)
//        if (aiController != null && aiController.IsAIEnabled())
//        {
//            aiController.RecordPlayerChoice(player1Choice);
//        }
...
//        {
//            // Player 1 didn't choose - Player 2 wins by default
//            string player2Name = isSinglePlayerMode ? "AI" : "Player 2";
//            result = $"Player 1 didn't choose - {player2Name} Wins Round " + round + "!";
...
//            // Player 2 didn't choose - Player 1 wins by default
//            string player2Name = isSinglePlayerMode ? "AI" : "Player 2";
//            result = $"{player2Name} didn't choose - Player 1 Wins Round " + round + "!";
...
//        {
//            string player2Name = isSinglePlayerMode ? "AI" : "Player 2";
//            result = $"{player2Name} Wins Round " + round + "!";
...
//            Invoke("ShowWinnerPanelWithDelay", winnerDelay + deathAnimationDelay);
//            string player2Name = isSinglePlayerMode ? "AI" : "Player 2";
//            winnerText.text = $"Player 1 Loses! {player2Name} Wins the Game!";
//            gameOver = true;
//        }
//        else if (player2Health <= 0)
//        {
...
//            Invoke("ShowWinnerPanelWithDelay", winnerDelay + deathAnimationDelay);
//            string player2Name = isSinglePlayerMode ? "AI" : "Player 2";
//            winnerText.text = $"{player2Name} Loses! Player 1 Wins the Game!";
//            gameOver = true;
//        }
//        else
//        {
...
//            player2HealthImage.fillAmount = player2Health / 100f;
//            string player2Name = isSinglePlayerMode ? "AI" : "Player 2";
//            player2HealthText.text = $"{player2Name} Health: " + player2Health;
//        }
//    }
...
//        // Stop AI decision making if it hasn't decided yet
//        if (aiController != null && aiController.IsAIEnabled())
//        {
//            aiController.ResetAI();
//        }
...
//    // Public method to toggle between single and multiplayer modes
...
//        OnSinglePlayerToggleChanged(isSinglePlayerMode);
//    }

//    // Public method to set difficulty (for UI buttons)
...
public class SpiderGameManager : MonoBehaviour
{
    ...
    public void CompareSelections()
    {
        ...
        if (player1Choice == 0 && player2Choice == 0)
        {
            ...
            // Play draw animation for both spiders
            Invoke("PlayBothDrawAnimations", animationDelay);
    ...
    private void PlayBothDrawAnimations()
    {
        if (player1Spider != null) player1Spider.PlayDrawAnimation();
        if (player2Spider != null) player2Spider.PlayDrawAnimation();
    }
