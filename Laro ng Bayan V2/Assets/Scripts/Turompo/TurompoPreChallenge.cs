...
public class TurompoPreChallenge : MonoBehaviour
{
    ...
    public Image player2KeyIndicatorImage; // Player 2 uses an image sprite
    public Slider tugOfWarSlider;
    public RectTransform player1DangerLine;
    public RectTransform player2DangerLine;
    public TextMeshProUGUI resultText;
    ...
    [Header("Player 2 Arrow Sprites")]
    public Sprite upArrowSprite;
    public Sprite downArrowSprite;
    public Sprite leftArrowSprite;
    public Sprite rightArrowSprite;

    private Dictionary<KeyCode, Sprite> arrowSprites;
    ...
    void Start()
    {
        ...
        // Setup arrow sprite mapping
        arrowSprites = new Dictionary<KeyCode, Sprite>()
        {
    ...
    private void SwitchKeys()
    {
        ...
        if (player2KeyIndicatorImage != null && arrowSprites.ContainsKey(currentPlayer2Key))
            player2KeyIndicatorImage.sprite = arrowSprites[currentPlayer2Key];
    }
