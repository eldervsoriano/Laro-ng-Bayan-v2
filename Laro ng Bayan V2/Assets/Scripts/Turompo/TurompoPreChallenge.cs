...
public class TurompoPreChallenge : MonoBehaviour
{
    ...
    private IEnumerator PlayTransitionAnimation()
    {
        ...
        if (videoPlayer != null && videoPlayer.clip != null)
        {
            // Subscribe to the loopPointReached event BEFORE playing
            videoPlayer.loopPointReached += OnVideoFinished;
            ...
            while (videoPlaying)
            {
                // Check for skip input if allowed
                ...
                // Safety check - if video somehow stops playing without triggering callback
